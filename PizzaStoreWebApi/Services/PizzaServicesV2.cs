...
{
    public class PizzaServicesV2: IPizzaServicesV2
    {
        public readonly IMongoCollection<PizzasDetails> pizzaCollection;

        public PizzaServicesV2(IOptions<PizzaStoreDatabaseSettings> pizzaStoreDatabaseSettings)
        {
       ...
       // [Route("pizzas")]
        ...
        public async Task<PizzaResponse> AddPizzaAsync(PizzasDetails productDetails)
        {
            ...
            byte[] binaryContent = File.ReadAllBytes(@"D:\Diploma\MVC and Non Relational Databases\Assessment_2\PizzaStoreWebApi\Images\" + productDetails.File.FileName.ToString());
